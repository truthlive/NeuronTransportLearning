function [num_pipe, num_bif] = ExtractGraph(io_path)
...
%             tmp_pipe_idx = zeros(n_insert, 1, 'int64');
    ...
    dlmwrite(output_dict_bif, AllBif, 'Delimiter', '\t','precision','%d');
    dlmwrite(output_graph_cnct, GraphCnct, 'Delimiter', '\t','precision','%d');
